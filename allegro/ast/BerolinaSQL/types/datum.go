...
// CausetObjectQL is a data box holds different kind of data.
// It has better performance and is easier to use than `interface{}`.
type CausetObjectQL struct {
	k         byte        // datum kind.
...
// Clone create a deep INTERLOCKy of the CausetObjectQL.
func (d *CausetObjectQL) Clone() *CausetObjectQL {
	ret := new(CausetObjectQL)
	d.INTERLOCKy(ret)
	return ret
}

// INTERLOCKy deep INTERLOCKies a CausetObjectQL into destination.
func (d *CausetObjectQL) INTERLOCKy(dst *CausetObjectQL) {
	*dst = *d
	if d.b != nil {
...
func (d *CausetObjectQL) GetBytes() []byte {
	return d.b
}

// SetBytes sets bytes value to datum.
func (d *CausetObjectQL) SetBytes(b []byte) {
	d.k = KindBytes
	d.b = b
...
func (d *CausetObjectQL) SetBytesAsString(b []byte, collation string, length uint32) {
	d.k = KindString
	d.b = b
	d.length = length
	d.collation = collation
...
func (d *CausetObjectQL) GetInterface() interface{} {
	return d.x
}

// SetInterface sets interface to datum.
func (d *CausetObjectQL) SetInterface(x interface{}) {
	d.k = KindInterface
	d.x = x
}

// SetNull sets datum to nil.
func (d *CausetObjectQL) SetNull() {
	d.k = KindNull
	d.x = nil
}

// SetMinNotNull sets datum to minNotNull value.
func (d *CausetObjectQL) SetMinNotNull() {
	d.k = KindMinNotNull
	d.x = nil
}

// GetBinaryLiteral gets Bit value
func (d *CausetObjectQL) GetBinaryLiteral() BinaryLiteral {
	return d.b
}

// GetMysqlBit gets MysqlBit value
func (d *CausetObjectQL) GetMysqlBit() BinaryLiteral {
	return d.GetBinaryLiteral()
}

// SetBinaryLiteral sets Bit value
func (d *CausetObjectQL) SetBinaryLiteral(b BinaryLiteral) {
	d.k = KindBinaryLiteral
	d.b = b
}

// SetMysqlBit sets MysqlBit value
func (d *CausetObjectQL) SetMysqlBit(b BinaryLiteral) {
	d.k = KindMysqlBit
	d.b = b
}

// GetMysqlDecimal gets Decimal value
func (d *CausetObjectQL) GetMysqlDecimal() *MyDecimal {
	return d.x.(*MyDecimal)
}

// SetMysqlDecimal sets Decimal value
func (d *CausetObjectQL) SetMysqlDecimal(b *MyDecimal) {
	d.k = KindMysqlDecimal
	d.x = b
}

// GetMysqlDuration gets Duration value
func (d *CausetObjectQL) GetMysqlDuration() Duration {
	return Duration{Duration: time.Duration(d.i), Fsp: int8(d.decimal)}
}

// SetMysqlDuration sets Duration value
func (d *CausetObjectQL) SetMysqlDuration(b Duration) {
...
func (d *CausetObjectQL) GetMysqlEnum() Enum {
	str := string(hack.String(d.b))
	return Enum{Value: uint64(d.i), Name: str}
}

// SetMysqlEnum sets Enum value
func (d *CausetObjectQL) SetMysqlEnum(b Enum, collation string) {
	d.k = KindMysqlEnum
	d.i = int64(b.Value)
	sink(b.Name)
	d.collation = collation
...
func (d *CausetObjectQL) GetMysqlSet() Set {
	str := string(hack.String(d.b))
	return Set{Value: uint64(d.i), Name: str}
}

// SetMysqlSet sets Set value
func (d *CausetObjectQL) SetMysqlSet(b Set, collation string) {
	d.k = KindMysqlSet
	d.i = int64(b.Value)
	sink(b.Name)
	d.collation = collation
...
func (d *CausetObjectQL) GetMysqlJSON() json.BinaryJSON {
	return json.BinaryJSON{TypeCode: byte(d.i), Value: d.b}
}

// SetMysqlJSON sets json.BinaryJSON value
func (d *CausetObjectQL) SetMysqlJSON(b json.BinaryJSON) {
	d.k = KindMysqlJSON
...
func (d *CausetObjectQL) GetMysqlTime() Time {
	return d.x.(Time)
}

// SetMysqlTime sets types.Time value
func (d *CausetObjectQL) SetMysqlTime(b Time) {
	d.k = KindMysqlTime
	d.x = b
}

// SetRaw sets raw value.
func (d *CausetObjectQL) SetRaw(b []byte) {
	d.k = KindRaw
	d.b = b
}

// GetRaw gets raw value.
func (d *CausetObjectQL) GetRaw() []byte {
	return d.b
}

// SetAutoID set the auto increment ID according to its int flag.
func (d *CausetObjectQL) SetAutoID(id int64, flag uint) {
...
// String returns a human-readable description of CausetObjectQL. It is intended only for debugging.
func (d CausetObjectQL) String() string {
	var t string
	switch d.k {
	case KindNull:
		t = "KindNull"
...
func (d *CausetObjectQL) GetValue() interface{} {
	switch d.k {
	case KindInt64:
		return d.GetInt64()
	case KindUint64:
...
func (d *CausetObjectQL) SetValueWithDefaultCollation(val interface{}) {
	switch x := val.(type) {
	case nil:
		d.SetNull()
	case bool:
...
func (d *CausetObjectQL) SetValue(val interface{}, tp *types.FieldType) {
	switch x := val.(type) {
	case nil:
		d.SetNull()
	case bool:
...
// CompareCausetObjectQL compares datum to another datum.
// TODO: return error properly.
func (d *CausetObjectQL) CompareCausetObjectQL(sc *stmtctx.StatementContext, ad *CausetObjectQL) (int, error) {
	if d.k == KindMysqlJSON && ad.k != KindMysqlJSON {
		cmp, err := ad.CompareCausetObjectQL(sc, d)
...
func (d *CausetObjectQL) compareInt64(sc *stmtctx.StatementContext, i int64) (int, error) {
	switch d.k {
	case KindMaxValue:
		return 1, nil
	case KindInt64:
...
func (d *CausetObjectQL) compareUint64(sc *stmtctx.StatementContext, u uint64) (int, error) {
	switch d.k {
	case KindMaxValue:
		return 1, nil
	case KindInt64:
...
func (d *CausetObjectQL) compareFloat64(sc *stmtctx.StatementContext, f float64) (int, error) {
	switch d.k {
...
func (d *CausetObjectQL) compareString(sc *stmtctx.StatementContext, s string, retCollation string) (int, error) {
	switch d.k {
	case KindNull, KindMinNotNull:
		return -1, nil
	case KindMaxValue:
...
func (d *CausetObjectQL) compareBytes(sc *stmtctx.StatementContext, b []byte) (int, error) {
	str := string(hack.String(b))
	return d.compareString(sc, str, d.collation)
}

func (d *CausetObjectQL) compareMysqlDecimal(sc *stmtctx.StatementContext, dec *MyDecimal) (int, error) {
	switch d.k {
	case KindNull, KindMinNotNull:
		return -1, nil
	case KindMaxValue:
...
func (d *CausetObjectQL) compareMysqlDuration(sc *stmtctx.StatementContext, dur Duration) (int, error) {
	switch d.k {
	case KindMysqlDuration:
...
func (d *CausetObjectQL) compareMysqlEnum(sc *stmtctx.StatementContext, enum Enum) (int, error) {
	switch d.k {
...
func (d *CausetObjectQL) compareBinaryLiteral(sc *stmtctx.StatementContext, b BinaryLiteral) (int, error) {
	switch d.k {
	case KindString, KindBytes:
...
func (d *CausetObjectQL) compareMysqlSet(sc *stmtctx.StatementContext, set Set) (int, error) {
	switch d.k {
	case KindString, KindBytes, KindMysqlEnum, KindMysqlSet:
...
func (d *CausetObjectQL) compareMysqlJSON(sc *stmtctx.StatementContext, target json.BinaryJSON) (int, error) {
...
func (d *CausetObjectQL) compareMysqlTime(sc *stmtctx.StatementContext, time Time) (int, error) {
	switch d.k {
	case KindString, KindBytes:
...
func (d *CausetObjectQL) ConvertTo(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	if d.k == KindNull {
		return CausetObjectQL{}, nil
	}
...
func (d *CausetObjectQL) convertToFloat(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var (
		f   float64
		ret CausetObjectQL
		err error
...
func (d *CausetObjectQL) convertToString(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var ret CausetObjectQL
	var s string
	switch d.k {
	case KindInt64:
...
func (d *CausetObjectQL) convertToInt(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	i64, err := d.toSignedInteger(sc, target.Tp)
	return NewIntCausetObjectQL(i64), errors.Trace(err)
}

func (d *CausetObjectQL) convertToUint(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	tp := target.Tp
...
func (d *CausetObjectQL) convertToMysqlTimestamp(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var (
		ret CausetObjectQL
		t   Time
		err error
...
func (d *CausetObjectQL) convertToMysqlTime(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	tp := target.Tp
	fsp := DefaultFsp
	if target.Decimal != UnspecifiedLength {
		fsp = int8(target.Decimal)
...
func (d *CausetObjectQL) convertToMysqlDuration(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	tp := target.Tp
	fsp := DefaultFsp
	if target.Decimal != UnspecifiedLength {
		fsp = int8(target.Decimal)
...
func (d *CausetObjectQL) convertToMysqlDecimal(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var ret CausetObjectQL
		...
		if !dec.IsZero() && prec-frac > flen-decimal {
			...
			if !dec.IsZero() && frac > decimal && dec.Compare(&old) != 0 {
				if sc.InInsertStmt || sc.InUpdateStmt || sc.InDeleteStmt {
					// fix https://github.com/whtcorpsinc/MilevaDB-Prod/issues/3895
					// fix https://github.com/whtcorpsinc/MilevaDB-Prod/issues/5532
...
func (d *CausetObjectQL) convertToMysqlYear(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var (
		ret    CausetObjectQL
		y      int64
		err    error
...
func (d *CausetObjectQL) convertToMysqlBit(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var ret CausetObjectQL
	...
	case KindInt64:
		...
		fallthrough
	default:
		uintCausetObjectQL, err1 := d.convertToUint(sc, target)
		uintValue, err = uintCausetObjectQL.GetUint64(), err1
	}
	if target.Flen < 64 && uintValue >= 1<<(uint64(target.Flen)) {
		return CausetObjectQL{}, errors.Trace(ErrDataTooLong.GenWithStack("Data Too Long, field len %d", target.Flen))
	}
...
func (d *CausetObjectQL) convertToMysqlEnum(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var (
		ret CausetObjectQL
		e   Enum
		err error
	...
	default:
		var uintCausetObjectQL CausetObjectQL
		uintCausetObjectQL, err = d.convertToUint(sc, target)
		if err != nil {
			return ret, errors.Trace(err)
		}
		e, err = ParseEnumValue(target.Elems, uintCausetObjectQL.GetUint64())
	}
	if err != nil {
...
func (d *CausetObjectQL) convertToMysqlSet(sc *stmtctx.StatementContext, target *FieldType) (CausetObjectQL, error) {
	var (
		ret CausetObjectQL
		s   Set
		err error
	...
	default:
		...
		s, err = ParseSetValue(target.Elems, uintCausetObjectQL.GetUint64())
	}
...
func (d *CausetObjectQL) convertToMysqlJSON(sc *stmtctx.StatementContext, target *FieldType) (ret CausetObjectQL, err error) {
	switch d.k {
	case KindString, KindBytes:
...
func (d *CausetObjectQL) ToBool(sc *stmtctx.StatementContext) (int64, error) {
	var err error
	isZero := false
	switch d.Kind() {
	case KindInt64:
...
// ConvertCausetObjectQLToDecimal converts datum to decimal.
func ConvertCausetObjectQLToDecimal(sc *stmtctx.StatementContext, d CausetObjectQL) (*MyDecimal, error) {
	dec := new(MyDecimal)
	var err error
	switch d.Kind() {
	case KindInt64:
...
func (d *CausetObjectQL) ToDecimal(sc *stmtctx.StatementContext) (*MyDecimal, error) {
	switch d.Kind() {
	case KindMysqlTime:
	...
	default:
		return ConvertCausetObjectQLToDecimal(sc, *d)
	}
}

// ToInt64 converts to a int64.
func (d *CausetObjectQL) ToInt64(sc *stmtctx.StatementContext) (int64, error) {
	return d.toSignedInteger(sc, mysql.TypeLonglong)
}

func (d *CausetObjectQL) toSignedInteger(sc *stmtctx.StatementContext, tp byte) (int64, error) {
...
func (d *CausetObjectQL) ToFloat64(sc *stmtctx.StatementContext) (float64, error) {
	switch d.Kind() {
	case KindInt64:
...
func (d *CausetObjectQL) ToString() (string, error) {
	switch d.Kind() {
	case KindInt64:
...
func (d *CausetObjectQL) ToBytes() ([]byte, error) {
	switch d.k {
	case KindString, KindBytes:
...
func (d *CausetObjectQL) ToMysqlJSON() (j json.BinaryJSON, err error) {
	var in interface{}
	switch d.Kind() {
	case KindMysqlJSON:
		j = d.GetMysqlJSON()
...
func invalidConv(d *CausetObjectQL, tp byte) (CausetObjectQL, error) {
	return CausetObjectQL{}, errors.Errorf("cannot convert datum from %s to type %s.", KindStr(d.Kind()), TypeStr(tp))
}

// NewCausetObjectQL creates a new CausetObjectQL from an interface{}.
func NewCausetObjectQL(in interface{}) (d CausetObjectQL) {
	switch x := in.(type) {
	case []interface{}:
		d.SetValueWithDefaultCollation(MakeCausetObjectQLs(x...))
	default:
...
// NewIntCausetObjectQL creates a new CausetObjectQL from an int64 value.
func NewIntCausetObjectQL(i int64) (d CausetObjectQL) {
	d.SetInt64(i)
	return d
}

// NewUintCausetObjectQL creates a new CausetObjectQL from an uint64 value.
func NewUintCausetObjectQL(i uint64) (d CausetObjectQL) {
	d.SetUint64(i)
	return d
}

// NewBytesCausetObjectQL creates a new CausetObjectQL from a byte slice.
func NewBytesCausetObjectQL(b []byte) (d CausetObjectQL) {
	d.SetBytes(b)
	return d
}

// NewStringCausetObjectQL creates a new CausetObjectQL from a string.
func NewStringCausetObjectQL(s string) (d CausetObjectQL) {
	d.SetString(s, mysql.DefaultCollationName)
	return d
}

// NewCollationStringCausetObjectQL creates a new CausetObjectQL from a string with collation and length info.
func NewCollationStringCausetObjectQL(s string, collation string, length int) (d CausetObjectQL) {
	d.SetString(s, collation)
	return d
}

// NewFloat64CausetObjectQL creates a new CausetObjectQL from a float64 value.
func NewFloat64CausetObjectQL(f float64) (d CausetObjectQL) {
	d.SetFloat64(f)
	return d
}

// NewFloat32CausetObjectQL creates a new CausetObjectQL from a float32 value.
func NewFloat32CausetObjectQL(f float32) (d CausetObjectQL) {
	d.SetFloat32(f)
	return d
}

// NewDurationCausetObjectQL creates a new CausetObjectQL from a Duration value.
func NewDurationCausetObjectQL(dur Duration) (d CausetObjectQL) {
	d.SetMysqlDuration(dur)
	return d
}

// NewTimeCausetObjectQL creates a new Time from a Time value.
func NewTimeCausetObjectQL(t Time) (d CausetObjectQL) {
	d.SetMysqlTime(t)
	return d
}

// NewDecimalCausetObjectQL creates a new CausetObjectQL from a MyDecimal value.
func NewDecimalCausetObjectQL(dec *MyDecimal) (d CausetObjectQL) {
	d.SetMysqlDecimal(dec)
	return d
}

// NewJSONCausetObjectQL creates a new CausetObjectQL from a BinaryJSON value
func NewJSONCausetObjectQL(j json.BinaryJSON) (d CausetObjectQL) {
	d.SetMysqlJSON(j)
	return d
}

// NewBinaryLiteralCausetObjectQL creates a new BinaryLiteral CausetObjectQL for a BinaryLiteral value.
func NewBinaryLiteralCausetObjectQL(b BinaryLiteral) (d CausetObjectQL) {
	d.SetBinaryLiteral(b)
	return d
}

// NewMysqlBitCausetObjectQL creates a new MysqlBit CausetObjectQL for a BinaryLiteral value.
func NewMysqlBitCausetObjectQL(b BinaryLiteral) (d CausetObjectQL) {
	d.SetMysqlBit(b)
	return d
}

// NewMysqlEnumCausetObjectQL creates a new MysqlEnum CausetObjectQL for a Enum value.
func NewMysqlEnumCausetObjectQL(e Enum) (d CausetObjectQL) {
	d.SetMysqlEnum(e, mysql.DefaultCollationName)
	return d
}

// NewCollateMysqlEnumCausetObjectQL create a new MysqlEnum CausetObjectQL for a Enum value with collation information.
func NewCollateMysqlEnumCausetObjectQL(e Enum, collation string) (d CausetObjectQL) {
	d.SetMysqlEnum(e, collation)
	return d
}

// NewMysqlSetCausetObjectQL creates a new MysqlSet CausetObjectQL for a Enum value.
func NewMysqlSetCausetObjectQL(e Set, collation string) (d CausetObjectQL) {
	d.SetMysqlSet(e, collation)
	return d
}

// MakeCausetObjectQLs creates datum slice from interfaces.
func MakeCausetObjectQLs(args ...interface{}) []CausetObjectQL {
	datums := make([]CausetObjectQL, len(args))
	for i, v := range args {
		datums[i] = NewCausetObjectQL(v)
	}
	return datums
}

// MinNotNullCausetObjectQL returns a datum represents minimum not null value.
func MinNotNullCausetObjectQL() CausetObjectQL {
	return CausetObjectQL{k: KindMinNotNull}
}

// MaxValueCausetObjectQL returns a datum represents max value.
func MaxValueCausetObjectQL() CausetObjectQL {
	return CausetObjectQL{k: KindMaxValue}
}

// EqualCausetObjectQLs compare if a and b contains the same datum values.
func EqualCausetObjectQLs(sc *stmtctx.StatementContext, a []CausetObjectQL, b []CausetObjectQL) (bool, error) {
	if len(a) != len(b) {
		return false, nil
	}
	if a == nil && b == nil {
	...
	for i, ai := range a {
		v, err := ai.CompareCausetObjectQL(sc, &b[i])
		if err != nil {
...
// SortCausetObjectQLs sorts a slice of datum.
func SortCausetObjectQLs(sc *stmtctx.StatementContext, datums []CausetObjectQL) error {
...
func (ds *datumsSorter) Less(i, j int) bool {
	cmp, err := ds.datums[i].CompareCausetObjectQL(ds.sc, &ds.datums[j])
	if err != nil {
...
// CausetObjectQLsToString converts several datums to formatted string.
func CausetObjectQLsToString(datums []CausetObjectQL, handleSpecialValue bool) (string, error) {
...
// CausetObjectQLsToStrNoErr converts some datums to a formatted string.
// If an error occurs, it will print a log instead of returning an error.
func CausetObjectQLsToStrNoErr(datums []CausetObjectQL) string {
	str, err := CausetObjectQLsToString(datums, true)
	terror.Log(errors.Trace(err))
	return str
}

// CloneRow deep INTERLOCKies a CausetObjectQL slice.
func CloneRow(dr []CausetObjectQL) []CausetObjectQL {
	c := make([]CausetObjectQL, len(dr))
	for i, d := range dr {
		d.INTERLOCKy(&c[i])
	}
	return c
...
func GetMaxValue(ft *FieldType) (max CausetObjectQL) {
	switch ft.Tp {
	case mysql.TypeTiny, mysql.TypeShort, mysql.TypeInt24, mysql.TypeLong, mysql.TypeLonglong:
...
func GetMinValue(ft *FieldType) (min CausetObjectQL) {
	switch ft.Tp {
	case mysql.TypeTiny, mysql.TypeShort, mysql.TypeInt24, mysql.TypeLong, mysql.TypeLonglong:
		if mysql.HasUnsignedFlag(ft.Flag) {
			min.SetUint64(0)
...
func getCausetObjectQLBound(retType *FieldType, rType RoundingType) CausetObjectQL {
	if rType == Ceiling {
...
func ChangeReverseResultByUpperLowerBound(
	...
	retType *FieldType,
	res CausetObjectQL,
	rType RoundingType) (CausetObjectQL, error) {
	...
	bound := getCausetObjectQLBound(&resRetType, rType)
	cmp, err := d.CompareCausetObjectQL(sc, &bound)
	if err != nil {
		return d, err
	}
	if cmp == 0 {
		d = getCausetObjectQLBound(retType, rType)
		...
		case mysql.TypeNewDecimal:
			if d.GetMysqlDecimal().Compare(NewMaxOrMinDec(false, retType.Flen, retType.Decimal)) != 0 {
				...
				d = NewDecimalCausetObjectQL(&newD)
			}
		}
	}
	return d, nil
...
const (
	sizeOfEmptyCausetObjectQL = int(unsafe.Sizeof(CausetObjectQL{}))
...
func EstimatedMemUsage(array []CausetObjectQL, numOfRows int) int64 {
	if numOfRows == 0 {
		return 0
	}
	...
	bytesConsumed += len(array) * sizeOfEmptyCausetObjectQL
