...
func (s *testSnapshotSuite) TestSnapshotCache(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/whtcorpsinc/MilevaDB-Prod/causetstore/einsteindb/snapshot-get-cache-fail", `return(true)`), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/whtcorpsinc/MilevaDB-Prod/causetstore/einsteindb/snapshot-get-cache-fail"), IsNil)
}
