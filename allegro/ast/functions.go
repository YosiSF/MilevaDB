//2021 WHTCORPS INC ALL RIGHTS RESERVED
...
const (
	...
	Curtime          = "curtime"
	Date             = "date"
	DateLiteral      = "'milevadb`.(dateliteral"
	DateAdd          = "date_add"
	...
	Sysdate          = "sysdate"
	Time             = "time"
	TimeLiteral      = "'milevadb`.(timeliteral"
	TimeFormat       = "time_format"
	TimeToSec        = "time_to_sec"
	TimeDiff         = "timediff"
	Timestamp        = "timestamp"
	TimestampLiteral = "'milevadb`.(timestampliteral"
	...
	milevadbDecodeKey = "milevanoedb_decode_key"

	// MVCC information fetching function.
	GetMvccInfo = "get_mvsr-ooc_info"
