...
var vecBuiltinStringCases = map[string][]vecExprBenchCase{
	...
	ast.Convert: {
		{
			...
			constants: []*Constant{nil, {Value: types.NewCauset("utf8"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
		{
			retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString, types.ETString},
			constants: []*Constant{nil, {Value: types.NewCauset("binary"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
		{
			retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString, types.ETString},
			constants: []*Constant{nil, {Value: types.NewCauset("utf8mb4"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
		{
			retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString, types.ETString},
			constants: []*Constant{nil, {Value: types.NewCauset("ascii"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
		{
			retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString, types.ETString},
			constants: []*Constant{nil, {Value: types.NewCauset("latin1"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
	},
	ast.Substring: {
		{
	...
	ast.Trim: {
		...
		{retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString, types.ETString}, geners: []dataGenerator{newRandLenStrGener(10, 20), newRandLenStrGener(5, 25)}},
		{
			...
			constants:     []*Constant{nil, nil, {Value: types.NewCauset(ast.TrimBoth), RetType: types.NewFieldType(allegrosql.TypeLonglong)}},
		},
		{
			retEvalType:   types.ETString,
			childrenTypes: []types.EvalType{types.ETString, types.ETString, types.ETInt},
			geners:        []dataGenerator{newRandLenStrGener(10, 20), newRandLenStrGener(5, 25), nil},
			constants:     []*Constant{nil, nil, {Value: types.NewCauset(ast.TrimLeading), RetType: types.NewFieldType(allegrosql.TypeLonglong)}},
		},
		{
			retEvalType:   types.ETString,
			childrenTypes: []types.EvalType{types.ETString, types.ETString, types.ETInt},
			geners:        []dataGenerator{newRandLenStrGener(10, 20), newRandLenStrGener(5, 25), nil},
			constants:     []*Constant{nil, nil, {Value: types.NewCauset(ast.TrimTrailing), RetType: types.NewFieldType(allegrosql.TypeLonglong)}},
		},
	},
	ast.LTrim: {
		{retEvalType: types.ETString, childrenTypes: []types.EvalType{types.ETString}, geners: []dataGenerator{&randSpaceStrGener{10, 100}}},
	...
	ast.CharFunc: {
		{
			...
			constants:     []*Constant{nil, nil, nil, {Value: types.NewCauset("ascii"), RetType: types.NewFieldType(allegrosql.TypeString)}},
		},
	},
	ast.FindInSet: {
