...
func (b *builtinIsIPv4Sig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinJSONAnyValueSig) vecEvalJSON(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinRealAnyValueSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinStringAnyValueSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinIsIPv6Sig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinNameConstStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinDecimalAnyValueSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinUUIDSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ReserveString(n)
	var id uuid.UUID
	var err error
...
func (b *builtinNameConstDurationSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinLockSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeInt64(n, false)
	i64s := result.Int64s()
	for i := range i64s {
...
func (b *builtinDurationAnyValueSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinIntAnyValueSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinIsIPv4CompatSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
	...
	for i := 0; i < n; i++ {
		if buf.IsNull(i) {
			...
			// See example https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv4-compat
...
func (b *builtinNameConstIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinNameConstTimeSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinSleepSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinIsIPv4MappedSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
	...
	for i := 0; i < n; i++ {
		if buf.IsNull(i) {
			...
			// For IPv4, it should be byte slice with 4 bytes.
			// For IPv6, it should be byte slice with 16 bytes.
			// See example https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv4-mapped
			ipAddress := buf.GetBytes(i)
...
func (b *builtinNameConstDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinNameConstJSONSig) vecEvalJSON(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinInet6AtonSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
	...
	for i := 0; i < n; i++ {
		...
		if isMappedIpv6 {
			INTERLOCKy(res[12:], ipTo4)
			res[11] = 0xff
			res[10] = 0xff
		} else if ipTo4 == nil {
			INTERLOCKy(res, ip.To16())
		} else {
			INTERLOCKy(res, ipTo4)
		}
...
func (b *builtinTimeAnyValueSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinInetAtonSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinInet6NtoaSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	val, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
	}
	defer b.bufSlabPredictor.put(val)
...
func (b *builtinNameConstRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinReleaseLockSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeInt64(n, false)
	i64s := result.Int64s()
	for i := range i64s {
