...
// vecEvalInt evals FIELD(str,str1,str2,str3,...).
// See https://dev.allegrosql.com/doc/refman/5.7/en/string-functions.html#function_field
func (b *builtinFieldRealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// vecEvalInt evals FIELD(str,str1,str2,str3,...).
// See https://dev.allegrosql.com/doc/refman/5.7/en/string-functions.html#function_field
func (b *builtinFieldStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
