...
func (b *builtinArithmeticMultiplyRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinArithmeticDivideDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinArithmeticModIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	...
	defer b.bufSlabPredictor.put(lh)
...
func (b *builtinArithmeticModIntSig) modUU(lh, rh *chunk.DeferredCauset) error {
	lhi64s := lh.Int64s()
	rhi64s := rh.Int64s()
...
func (b *builtinArithmeticModIntSig) modUS(lh, rh *chunk.DeferredCauset) error {
	lhi64s := lh.Int64s()
	rhi64s := rh.Int64s()
...
func (b *builtinArithmeticModIntSig) modSU(lh, rh *chunk.DeferredCauset) error {
	lhi64s := lh.Int64s()
	rhi64s := rh.Int64s()
...
func (b *builtinArithmeticModIntSig) modSS(lh, rh *chunk.DeferredCauset) error {
	lhi64s := lh.Int64s()
	rhi64s := rh.Int64s()
...
func (b *builtinArithmeticMinusRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticMinusDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticMinusIntSig) minusFUU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusFUS(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusFSU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusUU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusUS(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusSU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticMinusIntSig) minusSS(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticModRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinArithmeticModDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticPlusRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticMultiplyDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticIntDivideDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	...
	for i, arg := range b.args {
		if buf[i], err = b.bufSlabPredictor.get(types.ETDecimal, n); err != nil {
			return err
		}
...
func (b *builtinArithmeticMultiplyIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinArithmeticDivideRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticIntDivideIntSig) divideUU(result *chunk.DeferredCauset, lhsI64s, rhsI64s, resultI64s []int64) error {
...
func (b *builtinArithmeticIntDivideIntSig) divideUS(result *chunk.DeferredCauset, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticIntDivideIntSig) divideSU(result *chunk.DeferredCauset, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticIntDivideIntSig) divideSS(result *chunk.DeferredCauset, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusIntSig) plusUU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusIntSig) plusUS(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusIntSig) plusSU(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusIntSig) plusSS(result *chunk.DeferredCauset, lhi64s, rhi64s, resulti64s []int64) error {
	for i := 0; i < len(lhi64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinArithmeticMultiplyIntUnsignedSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalInt(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
