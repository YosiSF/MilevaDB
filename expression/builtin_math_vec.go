...
func (b *builtinLog2Sig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinLog10Sig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinSqrtSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAcosSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAsinSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAtan1ArgSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAtan2ArgsSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinCosSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinCotSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinDegreesSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinExpSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinRadiansSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinSinSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinTanSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAbsDecSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinRoundDecSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
	d64s := result.Decimals()
...
func (b *builtinPowSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinFloorRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinLog2ArgsSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinCeilRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinRoundRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinRoundWithFracRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinTruncateRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	n := input.NumEvents()
...
func (b *builtinAbsRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalReal(b.ctx, input, result); err != nil {
		return err
	}
	f64s := result.Float64s()
...
func (b *builtinAbsIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinRoundIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
...
func (b *builtinRoundWithFracIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalInt(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinCRC32Sig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinPISig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinRandSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeFloat64(n, false)
	f64s := result.Float64s()
	b.mu.Lock()
...
func (b *builtinTruncateIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalInt(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinTruncateUintSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	if err := b.args[0].VecEvalInt(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinCeilDecToDecSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinFloorDecToDecSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinTruncateDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinRoundWithFracDecSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	if err := b.args[0].VecEvalDecimal(b.ctx, input, result); err != nil {
		return err
	}
...
func (b *builtinSignSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinConvSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAbsUIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	return b.args[0].VecEvalInt(b.ctx, input, result)
}
...
func (b *builtinCeilDecToIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinCeilIntToIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	return b.args[0].VecEvalInt(b.ctx, input, result)
}
...
func (b *builtinFloorIntToIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	return b.args[0].VecEvalInt(b.ctx, input, result)
}
...
func (b *builtinFloorDecToIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
