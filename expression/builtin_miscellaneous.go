...
func (c *sleepFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_sleep
func (b *builtinSleepSig) evalInt(event chunk.Event) (int64, bool, error) {
...
func (c *lockFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_get-dagger
// The dagger function will do nothing.
// Warning: get_lock() function is parsed but ignored.
func (b *builtinLockSig) evalInt(_ chunk.Event) (int64, bool, error) {
	return 1, false, nil
}
...
func (c *releaseLockFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_release-dagger
// The release dagger function will do nothing.
// Warning: release_lock() function is parsed but ignored.
func (b *builtinReleaseLockSig) evalInt(_ chunk.Event) (int64, bool, error) {
	return 1, false, nil
}
...
func (c *anyValueFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	*bf.tp = *args[0].GetType()
	...
	case types.ETDecimal:
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_DecimalAnyValue)
	...
	case types.ETJson:
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_JSONAnyValue)
	case types.ETReal:
		sig = &builtinRealAnyValueSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_RealAnyValue)
	case types.ETString:
		bf.tp.Decimal = types.UnspecifiedLength
		sig = &builtinStringAnyValueSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_StringAnyValue)
	case types.ETDatetime, types.ETTimestamp:
		bf.tp.Charset, bf.tp.DefCauslate, bf.tp.Flag = allegrosql.DefaultCharset, allegrosql.DefaultDefCauslationName, 0
		sig = &builtinTimeAnyValueSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_TimeAnyValue)
	default:
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinDecimalAnyValueSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinDurationAnyValueSig) evalDuration(event chunk.Event) (types.Duration, bool, error) {
	return b.args[0].EvalDuration(b.ctx, event)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinIntAnyValueSig) evalInt(event chunk.Event) (int64, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinJSONAnyValueSig) evalJSON(event chunk.Event) (json.BinaryJSON, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinRealAnyValueSig) evalReal(event chunk.Event) (float64, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinStringAnyValueSig) evalString(event chunk.Event) (string, bool, error) {
	return b.args[0].EvalString(b.ctx, event)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_any-value
func (b *builtinTimeAnyValueSig) evalTime(event chunk.Event) (types.Time, bool, error) {
	return b.args[0].EvalTime(b.ctx, event)
}
...
func (c *defaultFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *inetAtonFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.CausetEDN, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_inet-aton
func (b *builtinInetAtonSig) evalInt(event chunk.Event) (int64, bool, error) {
...
func (c *inetNtoaFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_inet-ntoa
func (b *builtinInetNtoaSig) evalString(event chunk.Event) (string, bool, error) {
...
func (c *inet6AtonFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_inet6-aton
func (b *builtinInet6AtonSig) evalString(event chunk.Event) (string, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return "", true, err
	}
	...
	if isMappedIpv6 {
		INTERLOCKy(result[12:], ip.To4())
		result[11] = 0xff
		result[10] = 0xff
	} else if ip.To4() == nil {
		INTERLOCKy(result, ip.To16())
	} else {
		INTERLOCKy(result, ip.To4())
	}
...
func (c *inet6NtoaFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_inet6-ntoa
func (b *builtinInet6NtoaSig) evalString(event chunk.Event) (string, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return "", true, err
	}
...
func (c *isFreeLockFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *isIPv4FunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.CausetEDN, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv4
func (b *builtinIsIPv4Sig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
...
func (c *isIPv4CompatFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.CausetEDN, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv4-compat
func (b *builtinIsIPv4CompatSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return 0, err != nil, err
	}
...
func (c *isIPv4MappedFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.CausetEDN, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv4-mapped
func (b *builtinIsIPv4MappedSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return 0, err != nil, err
	}
...
func (c *isIPv6FunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.CausetEDN, types.ETString)
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_is-ipv6
func (b *builtinIsIPv6Sig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return 0, err != nil, err
	}
...
func (c *isUsedLockFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *masterPosWaitFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *nameConstFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinNameConstDecimalSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
...
func (b *builtinNameConstIntSig) evalInt(event chunk.Event) (int64, bool, error) {
...
func (b *builtinNameConstRealSig) evalReal(event chunk.Event) (float64, bool, error) {
...
func (b *builtinNameConstStringSig) evalString(event chunk.Event) (string, bool, error) {
...
func (b *builtinNameConstJSONSig) evalJSON(event chunk.Event) (json.BinaryJSON, bool, error) {
...
func (b *builtinNameConstDurationSig) evalDuration(event chunk.Event) (types.Duration, bool, error) {
...
func (b *builtinNameConstTimeSig) evalTime(event chunk.Event) (types.Time, bool, error) {
...
func (c *releaseAllLocksFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *uuidFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_uuid
func (b *builtinUUIDSig) evalString(_ chunk.Event) (d string, isNull bool, err error) {
	var id uuid.UUID
	id, err = uuid.NewUUID()
	if err != nil {
		return
...
func (c *uuidShortFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
