...
func (b *builtinLTDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinLTStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinLTTimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinLTDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinLTJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinLERealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinLEDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinLEStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinLETimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinLEDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinLEJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinGTRealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinGTDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinGTStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinGTTimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinGTDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinGTJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinGERealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinGEDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinGEStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinGETimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinGEDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinGEJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinEQRealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinEQDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinEQStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinEQTimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinEQDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinEQJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinNERealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinNEDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinNEStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinNETimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinNEDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinNEJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinNullEQRealSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETReal, n)
	if err != nil {
		return err
...
func (b *builtinNullEQDecimalSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDecimal, n)
	if err != nil {
		return err
...
func (b *builtinNullEQStringSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
...
func (b *builtinNullEQTimeSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
	if err != nil {
		return err
...
func (b *builtinNullEQDurationSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETDuration, n)
	if err != nil {
		return err
...
func (b *builtinNullEQJSONSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	buf0, err := b.bufSlabPredictor.get(types.ETJson, n)
	if err != nil {
		return err
...
func (b *builtinCoalesceIntSig) fallbackEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinCoalesceIntSig) vecEvalInt(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceRealSig) fallbackEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	x := result.Float64s()
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalReal(input.GetEvent(i))
		if err != nil {
			return err
		}
		result.SetNull(i, isNull)
...
func (b *builtinCoalesceRealSig) vecEvalReal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceDecimalSig) fallbackEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	x := result.Decimals()
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalDecimal(input.GetEvent(i))
		if err != nil {
			return err
		}
		result.SetNull(i, isNull)
...
func (b *builtinCoalesceDecimalSig) vecEvalDecimal(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceStringSig) fallbackEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	result.ReserveString(n)
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalString(input.GetEvent(i))
		if err != nil {
			return err
		}
		if isNull {
...
func (b *builtinCoalesceStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	argLen := len(b.args)
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceTimeSig) fallbackEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	x := result.Times()
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalTime(input.GetEvent(i))
		if err != nil {
			return err
		}
		result.SetNull(i, isNull)
...
func (b *builtinCoalesceTimeSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceDurationSig) fallbackEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	x := result.GoDurations()
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalDuration(input.GetEvent(i))
		if err != nil {
			return err
		}
		result.SetNull(i, isNull)
...
func (b *builtinCoalesceDurationSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
// NOTE: Coalesce just return the first non-null item, but vectorization do each item, which would incur additional errors. If this case happen,
// the vectorization falls back to the scalar execution.
func (b *builtinCoalesceJSONSig) fallbackEvalJSON(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()

	result.ReserveJSON(n)
	for i := 0; i < n; i++ {
		res, isNull, err := b.evalJSON(input.GetEvent(i))
		if err != nil {
			return err
		}
		if isNull {
...
func (b *builtinCoalesceJSONSig) vecEvalJSON(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	argLen := len(b.args)
