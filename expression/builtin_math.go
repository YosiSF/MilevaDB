...
func (c *absFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	...
	if argTp == types.ETReal {
		bf.tp.Flen, bf.tp.Decimal = allegrosql.GetDefaultFieldLengthAndDecimal(allegrosql.TypeDouble)
	} else {
	...
	case types.CausetEDN:
		if allegrosql.HasUnsignedFlag(argFieldTp.Flag) {
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_AbsInt)
		}
	case types.ETDecimal:
		sig = &builtinAbsDecSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_AbsDecimal)
	case types.ETReal:
		sig = &builtinAbsRealSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_AbsReal)
	default:
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsRealSig) evalReal(event chunk.Event) (float64, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsIntSig) evalInt(event chunk.Event) (int64, bool, error) {
...
// evalInt evals ABS(value).
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsUIntSig) evalInt(event chunk.Event) (int64, bool, error) {
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
...
func (c *roundFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, c.verifyArgs(args)
	}
	...
	if len(args) > 1 {
		...
		case types.ETDecimal:
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_RoundWithFracDec)
		case types.ETReal:
			sig = &builtinRoundWithFracRealSig{bf}
			sig.setPbCode(fidelpb.ScalarFuncSig_RoundWithFracReal)
		default:
			panic("unexpected argTp")
		}
	} else {
		...
		case types.ETDecimal:
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_RoundDec)
		case types.ETReal:
			sig = &builtinRoundRealSig{bf}
			sig.setPbCode(fidelpb.ScalarFuncSig_RoundReal)
		default:
			panic("unexpected argTp")
		}
	}
...
func calculateDecimal4RoundAndTruncate(ctx stochastikctx.Context, args []Expression, retType types.EvalType) int {
	...
	argDec, isNull, err := secondConst.EvalInt(ctx, chunk.Event{})
	if err != nil || isNull || argDec < 0 {
		return 0
	}
	if argDec > allegrosql.MaxDecimalScale {
		return allegrosql.MaxDecimalScale
	}
	return int(argDec)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundRealSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	return b.args[0].EvalInt(b.ctx, event)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracRealSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
	frac, isNull, err := b.args[1].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
func (c *ceilFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (sig builtinFunc, err error) {
	if err = c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	case types.ETDecimal:
		if retTp == types.CausetEDN {
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_CeilDecToDec)
		}
	default:
		sig = &builtinCeilRealSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_CeilReal)
	}
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_ceil
func (b *builtinCeilRealSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_ceil
func (b *builtinCeilIntToIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	return b.args[0].EvalInt(b.ctx, event)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_Ceil
func (b *builtinCeilIntToDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return nil, true, err
	}

	if allegrosql.HasUnsignedFlag(b.args[0].GetType().Flag) || val >= 0 {
...
// Ceil receives
func (b *builtinCeilDecToIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinCeilDecToDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
func getEvalTp4FloorAndCeil(arg Expression) (retTp, argTp types.EvalType) {
	...
	case types.ETDecimal:
		if fieldTp.Flen-fieldTp.Decimal > allegrosql.MaxIntWidth-2 { // len(math.MaxInt64) - 1
			retTp = types.ETDecimal
		}
	default:
...
func setFlag4FloorAndCeil(tp *types.FieldType, arg Expression) {
	fieldTp := arg.GetType()
	if (fieldTp.Tp == allegrosql.TypeLong || fieldTp.Tp == allegrosql.TypeNewDecimal) && allegrosql.HasUnsignedFlag(fieldTp.Flag) {
		tp.Flag |= allegrosql.UnsignedFlag
	}
	// TODO: when argument type is timestamp, add not null flag.
}

func (c *floorFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (sig builtinFunc, err error) {
	if err = c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	case types.ETDecimal:
		if retTp == types.CausetEDN {
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_FloorDecToDec)
		}
	default:
		sig = &builtinFloorRealSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_FloorReal)
	}
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_floor
func (b *builtinFloorRealSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_floor
func (b *builtinFloorIntToIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	return b.args[0].EvalInt(b.ctx, event)
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_floor
func (b *builtinFloorIntToDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return nil, true, err
	}
...
// floor receives
func (b *builtinFloorDecToIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinFloorDecToDecSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return nil, true, err
	}
...
func (c *logFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var (
	...
	if argsLen == 1 {
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_Log1Arg)
	} else {
		sig = &builtinLog2ArgsSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_Log2Args)
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_log
func (b *builtinLog1ArgSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_log
func (b *builtinLog2ArgsSig) evalReal(event chunk.Event) (float64, bool, error) {
	val1, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}

	val2, isNull, err := b.args[1].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *log2FunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Log2)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_log2
func (b *builtinLog2Sig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *log10FunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Log10)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_log10
func (b *builtinLog10Sig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *randFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var sig builtinFunc
	...
	if len(args) == 0 {
		...
		seed, isNull, err := args[0].EvalInt(ctx, chunk.Event{})
		if err != nil {
			return nil, err
		}
		if isNull {
			// When the seed is null we need to use 0 as the seed.
			// The behavior same as MyALLEGROSQL.
			seed = 0
		}
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_RandWithSeedFirstGen)
	}
	return sig, nil
}
...
// evalReal evals RAND().
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_rand
func (b *builtinRandSig) evalReal(event chunk.Event) (float64, bool, error) {
	b.mu.Lock()
	res := b.mysqlRng.Gen()
	b.mu.Unlock()
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_rand
func (b *builtinRandWithSeedFirstGenSig) evalReal(event chunk.Event) (float64, bool, error) {
	seed, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if err != nil {
		return 0, true, err
	}
	// b.args[0] is promised to be a non-constant(such as a defCausumn name) in
...
func (c *powFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Pow)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_pow
func (b *builtinPowSig) evalReal(event chunk.Event) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
	y, isNull, err := b.args[1].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
	power := math.Pow(x, y)
...
func (c *convFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_conv.
func (b *builtinConvSig) evalString(event chunk.Event) (res string, isNull bool, err error) {
	str, isNull, err := b.args[0].EvalString(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}

	fromBase, isNull, err := b.args[1].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}

	toBase, isNull, err := b.args[2].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *crc32FunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_CRC32)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_crc32
func (b *builtinCRC32Sig) evalInt(event chunk.Event) (int64, bool, error) {
	x, isNull, err := b.args[0].EvalString(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *signFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Sign)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_sign
func (b *builtinSignSig) evalInt(event chunk.Event) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *sqrtFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Sqrt)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_sqrt
func (b *builtinSqrtSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *acosFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Acos)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_acos
func (b *builtinAcosSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *asinFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Asin)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_asin
func (b *builtinAsinSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *atanFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var (
	...
	if argsLen == 1 {
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_Atan1Arg)
	} else {
		sig = &builtinAtan2ArgsSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_Atan2Args)
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_atan
func (b *builtinAtan1ArgSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_atan
func (b *builtinAtan2ArgsSig) evalReal(event chunk.Event) (float64, bool, error) {
	val1, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *cosFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Cos)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_cos
func (b *builtinCosSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *cotFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Cot)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_cot
func (b *builtinCotSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *degreesFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Degrees)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_degrees
func (b *builtinDegreesSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *expFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Exp)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_exp
func (b *builtinExpSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *piFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var (
	...
	bf.tp.Flen = 8
	sig = &builtinPISig{bf}
	sig.setPbCode(fidelpb.ScalarFuncSig_PI)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_pi
func (b *builtinPISig) evalReal(_ chunk.Event) (float64, bool, error) {
...
func (c *radiansFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Radians)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_radians
func (b *builtinRadiansSig) evalReal(event chunk.Event) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *sinFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Sin)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_sin
func (b *builtinSinSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *tanFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETReal, types.ETReal)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_Tan)
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_tan
func (b *builtinTanSig) evalReal(event chunk.Event) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *truncateFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}

	argTp := args[0].GetType().EvalType()
	if argTp.IsStringHoTT() {
		argTp = types.ETReal
	}
	...
	case types.CausetEDN:
		if allegrosql.HasUnsignedFlag(args[0].GetType().Flag) {
			...
			sig.setPbCode(fidelpb.ScalarFuncSig_TruncateInt)
		}
	case types.ETReal:
		sig = &builtinTruncateRealSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_TruncateReal)
	case types.ETDecimal:
		sig = &builtinTruncateDecimalSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_TruncateDecimal)
	default:
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateDecimalSig) evalDecimal(event chunk.Event) (*types.MyDecimal, bool, error) {
	x, isNull, err := b.args[0].EvalDecimal(b.ctx, event)
	if isNull || err != nil {
		return nil, isNull, err
	}

	d, isNull, err := b.args[1].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateRealSig) evalReal(event chunk.Event) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateIntSig) evalInt(event chunk.Event) (int64, bool, error) {
	x, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
	if allegrosql.HasUnsignedFlag(b.args[1].GetType().Flag) {
		return x, false, nil
	}
...
// evalInt evals a TRUNCATE(X,D).
// See https://dev.allegrosql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateUintSig) evalInt(event chunk.Event) (int64, bool, error) {
	x, isNull, err := b.args[0].EvalInt(b.ctx, event)
	if isNull || err != nil {
		return 0, isNull, err
	}
