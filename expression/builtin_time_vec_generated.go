...
func (b *builtinAddDatetimeAndStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddDurationAndDurationSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddDurationAndStringSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddStringAndDurationSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddStringAndStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddDateAndDurationSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddDateAndStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddTimeDateTimeNullSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddTimeStringNullSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinAddTimeDurationNullSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubDatetimeAndDurationSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	...
	for i := 0; i < n; i++ {
		...
		output, err := tmFIDeluration.ConvertToTime(sc, arg0.Type())
...
func (b *builtinSubDatetimeAndStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	...
	for i := 0; i < n; i++ {
		...
		tmFIDeluration := arg0.Sub(sc, &arg1time)
		output, err := tmFIDeluration.ConvertToTime(sc, allegrosql.TypeDatetime)
...
func (b *builtinSubDurationAndDurationSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubDurationAndStringSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubStringAndDurationSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubStringAndStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubDateAndDurationSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubDateAndStringSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubTimeDateTimeNullSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubTimeStringNullSig) vecEvalString(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinSubTimeDurationNullSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinNullTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, true)
	return nil
}
...
func (b *builtinTimeStringTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
...
func (b *builtinDurationStringTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf0 := result
...
func (b *builtinDurationDurationTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf0 := result
...
func (b *builtinStringTimeTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
...
func (b *builtinStringDurationTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf1 := result
...
func (b *builtinStringStringTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf0, err := b.bufSlabPredictor.get(types.ETString, n)
...
func (b *builtinTimeTimeTimeDiffSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	result.ResizeGoDuration(n, false)
	r64s := result.GoDurations()
	buf0, err := b.bufSlabPredictor.get(types.ETDatetime, n)
...
func (b *builtinAddDateStringStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
	}
	if isNull {
	...
	intervalBuf, err := b.bufSlabPredictor.get(types.ETString, n)
	if err != nil {
		return err
	}
	defer b.bufSlabPredictor.put(intervalBuf)
...
func (b *builtinAddDateStringIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateStringRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateStringDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateIntStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateIntIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateIntRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateIntDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDatetimeStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDatetimeIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDatetimeRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDatetimeDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDurationStringSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDurationIntSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDurationRealSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinAddDateDurationDecimalSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateStringStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateStringIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateStringRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateStringDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateIntStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateIntIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateIntRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateIntDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDatetimeStringSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDatetimeIntSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDatetimeRealSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDatetimeDecimalSig) vecEvalTime(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDurationStringSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDurationIntSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDurationRealSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
...
func (b *builtinSubDateDurationDecimalSig) vecEvalDuration(input *chunk.Chunk, result *chunk.DeferredCauset) error {
	n := input.NumEvents()
	unit, isNull, err := b.args[2].EvalString(b.ctx, chunk.Event{})
	if err != nil {
		return err
