...
func (c *jsonTypeFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (b *builtinJSONTypeSig) evalString(event chunk.Event) (res string, isNull bool, err error) {
	var j json.BinaryJSON
	j, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *jsonExtractFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonExtractSig)
	return sig, nil
}

func (b *builtinJSONExtractSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return
	}
	...
	for _, arg := range b.args[1:] {
		var s string
		s, isNull, err = arg.EvalString(b.ctx, event)
		if isNull || err != nil {
...
func (c *jsonUnquoteFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonUnquoteSig)
	return sig, nil
}

func (b *builtinJSONUnquoteSig) evalString(event chunk.Event) (string, bool, error) {
...
func (c *jsonSetFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonSetSig)
	return sig, nil
}

func (b *builtinJSONSetSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.ctx, b.args, event, json.ModifySet)
	return res, isNull, err
}
...
func (c *jsonInsertFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonInsertSig)
	return sig, nil
}

func (b *builtinJSONInsertSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.ctx, b.args, event, json.ModifyInsert)
	return res, isNull, err
}
...
func (c *jsonReplaceFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonReplaceSig)
	return sig, nil
}

func (b *builtinJSONReplaceSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.ctx, b.args, event, json.ModifyReplace)
	return res, isNull, err
}
...
func (c *jsonRemoveFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonRemoveSig)
	return sig, nil
}

func (b *builtinJSONRemoveSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonMergeFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonMergeSig)
	return sig, nil
}

func (b *builtinJSONMergeSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	values := make([]json.BinaryJSON, 0, len(b.args))
	for _, arg := range b.args {
		var value json.BinaryJSON
		value, isNull, err = arg.EvalJSON(b.ctx, event)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func (c *jsonObjectFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 0 {
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonObjectSig)
	return sig, nil
}

func (b *builtinJSONObjectSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	if len(b.args)&1 == 1 {
	...
	for i, arg := range b.args {
		if i&1 == 0 {
			key, isNull, err = arg.EvalString(b.ctx, event)
			if err != nil {
				return res, true, err
			}
			if isNull {
...
func (c *jsonArrayFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonArraySig)
	return sig, nil
}

func (b *builtinJSONArraySig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	jsons := make([]interface{}, 0, len(b.args))
	for _, arg := range b.args {
		j, isNull, err := arg.EvalJSON(b.ctx, event)
		if err != nil {
			return res, true, err
		}
		if isNull {
...
func (c *jsonContainsPathFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonContainsPathSig)
	return sig, nil
}

func (b *builtinJSONContainsPathSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	containType, isNull, err := b.args[1].EvalString(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	...
	for i := 2; i < len(b.args); i++ {
		path, isNull, err := b.args[i].EvalString(b.ctx, event)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func jsonModify(ctx stochastikctx.Context, args []Expression, event chunk.Event, mt json.ModifyType) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = args[0].EvalJSON(ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	...
	for i := 1; i < len(args); i += 2 {
		...
		var s string
		s, isNull, err = args[i].EvalString(ctx, event)
		if isNull || err != nil {
			return res, isNull, err
		}
		var pathExpr json.PathExpression
	...
	for i := 2; i < len(args); i += 2 {
		var value json.BinaryJSON
		value, isNull, err = args[i].EvalJSON(ctx, event)
		if err != nil {
			return res, true, err
		}
		if isNull {
...
func (c *jsonContainsFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonContainsSig)
	return sig, nil
}

func (b *builtinJSONContainsSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	target, isNull, err := b.args[1].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	var pathExpr json.PathExpression
	if len(b.args) == 3 {
		path, isNull, err := b.args[2].EvalString(b.ctx, event)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func (c *jsonValidFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	default:
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_JsonValidOthersSig)
	}
	return sig, nil
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/json-attribute-functions.html#function_json-valid
func (b *builtinJSONValidJSONSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	_, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	return 1, isNull, err
}
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/json-attribute-functions.html#function_json-valid
func (b *builtinJSONValidStringSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	val, isNull, err := b.args[0].EvalString(b.ctx, event)
	if err != nil || isNull {
		return 0, isNull, err
	}

	data := replog.Slice(val)
	if json2.Valid(data) {
		res = 1
	} else {
		res = 0
...
// See https://dev.allegrosql.com/doc/refman/5.7/en/json-attribute-functions.html#function_json-valid
func (b *builtinJSONValidOthersSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	return 0, false, nil
}
...
func (c *jsonArrayAppendFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonArrayAppendSig)
	return sig, nil
}
...
func (b *builtinJSONArrayAppendSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		// If JSON path is NULL, MyALLEGROSQL breaks and returns NULL.
		s, sNull, err := b.args[i].EvalString(b.ctx, event)
		if sNull || err != nil {
			return res, true, err
		}
		value, vNull, err := b.args[i+1].EvalJSON(b.ctx, event)
		if err != nil {
			return res, true, err
		}
		if vNull {
...
func (c *jsonArrayInsertFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonArrayInsertSig)
	return sig, nil
}
...
func (b *builtinJSONArrayInsertSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		// If JSON path is NULL, MyALLEGROSQL breaks and returns NULL.
		s, isNull, err := b.args[i].EvalString(b.ctx, event)
		if err != nil || isNull {
			return res, true, err
		}
		...
		value, isnull, err := b.args[i+1].EvalJSON(b.ctx, event)
		if err != nil {
			return res, true, err
		}
...
func (c *jsonMergePatchFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *jsonMergePreserveFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	sig := &builtinJSONMergeSig{bf}
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonMergePreserveSig)
	return sig, nil
}
...
func (c *jsonPrettyFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
...
func (c *jsonQuoteFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonQuoteSig)
	return sig, nil
}

func (b *builtinJSONQuoteSig) evalString(event chunk.Event) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(b.ctx, event)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *jsonSearchFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonSearchSig)
	return sig, nil
}

func (b *builtinJSONSearchSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	// json_doc
	...
	searchStr, isNull, err = b.args[2].EvalString(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
	escape := byte('\\')
	if len(b.args) >= 4 {
		...
		escapeStr, isNull, err = b.args[3].EvalString(b.ctx, event)
		if err != nil {
			return res, isNull, err
		}
...
func (c *jsonStorageSizeFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonStorageSizeSig)
	return sig, nil
}

func (b *builtinJSONStorageSizeSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonDepthFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonDepthSig)
	return sig, nil
}

func (b *builtinJSONDepthSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonKeysFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	case 1:
		...
		sig.setPbCode(fidelpb.ScalarFuncSig_JsonKeysSig)
	case 2:
		sig = &builtinJSONKeys2ArgsSig{bf}
		sig.setPbCode(fidelpb.ScalarFuncSig_JsonKeys2ArgsSig)
	}
	return sig, nil
}
...
func (b *builtinJSONKeysSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONKeys2ArgsSig) evalJSON(event chunk.Event) (res json.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}

	path, isNull, err := b.args[1].EvalString(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonLengthFunctionClass) getFunction(ctx stochastikctx.Context, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	sig.setPbCode(fidelpb.ScalarFuncSig_JsonLengthSig)
	return sig, nil
}

func (b *builtinJSONLengthSig) evalInt(event chunk.Event) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(b.ctx, event)
	if isNull || err != nil {
		return res, isNull, err
	}
