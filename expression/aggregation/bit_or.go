...
func (bf *bitOrFunction) UFIDelate(evalCtx *AggEvaluateContext, sc *stmtctx.StatementContext, event chunk.Event) error {
	a := bf.Args[0]
...
func (bf *bitOrFunction) GetResult(evalCtx *AggEvaluateContext) types.Causet {
	return evalCtx.Value
}

// GetPartialResult implements Aggregation interface.
func (bf *bitOrFunction) GetPartialResult(evalCtx *AggEvaluateContext) []types.Causet {
