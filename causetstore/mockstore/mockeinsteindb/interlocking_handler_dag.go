...
import (
	...
	"github.com/whtcorpsinc/solomonkeyproto/pkg/einsteindbpb"
...
func (h *rpcHandler) extractKVRanges(keyRanges []*interlock.KeyRange, descScan bool) (kvRanges []solomonkey.KeyRange, err error) {
