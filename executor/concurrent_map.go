...
// To avoid dagger bottlenecks this map is dived to several (ShardCount) map shards.
...
// It is called while dagger is held, therefore it MUST NOT
// try to access other keys in same map, as it can lead to deadlock since
// Go sync.RWLock is not reentrant
type UpsertCb func(exist bool, valueInMap, newValue *entry) *entry

// Upsert: Insert or UFIDelate - uFIDelates existing element or inserts a new one using UpsertCb
