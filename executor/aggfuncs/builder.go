...
func BuildWindowFunctions(ctx stochastikctx.Context, windowFuncDesc *aggregation.AggFuncDesc, ordinal int, orderByDefCauss []*expression.DeferredCauset) AggFunc {
...
func buildApproxCountDistinct(aggFuncDesc *aggregation.AggFuncDesc, ordinal int) AggFunc {
	...
	// In partition block, union need to compute partial result into partial result.
...
func buildRank(ordinal int, orderByDefCauss []*expression.DeferredCauset, isDense bool) AggFunc {
	base := baseAggFunc{
		ordinal: ordinal,
	}
...
func buildCumeDist(ordinal int, orderByDefCauss []*expression.DeferredCauset) AggFunc {
	base := baseAggFunc{
		ordinal: ordinal,
	}
...
func buildPercenRank(ordinal int, orderByDefCauss []*expression.DeferredCauset) AggFunc {
	base := baseAggFunc{
		ordinal: ordinal,
	}
