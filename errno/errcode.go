...
// MyALLEGROSQL error code.
// This value is numeric. It is not porblock to other database systems.
const (
	...
	ErrTooLongKey                                                   = 1071
	ErrKeyDeferredCausetDoesNotExits                                = 1072
	...
	ErrTableMustHaveDeferredCausets                                 = 1113
	...
	ErrNullDeferredCausetInIndex                                    = 1121
	ErrCantFindUdf                                                  = 1122
	...
	ErrDeferredCausetaccessDenied                                   = 1143
	...
	ErrWrongDeferredCausetName                                      = 1166
	ErrWrongKeyDeferredCauset                                       = 1167
	...
	ErrUFIDelateWithoutKeyInSafeMode                                = 1175
	...
	ErrOperandDeferredCausets                                       = 1241
	ErrSubqueryNo1Row                                               = 1242
	ErrUnknownStmtHandler                                           = 1243
	ErrCorruptHelFIDelB                                             = 1244
	...
	ErrDefCauslationCharsetMismatch                                 = 1253
	...
	ErrSFIDeloesNotExist                                            = 1305
	ErrSFIDelropFailed                                              = 1306
	...
	ErrSFIDelupParam                                                = 1330
	ErrSFIDelupVar                                                  = 1331
	ErrSFIDelupCond                                                 = 1332
	ErrSFIDelupCurs                                                 = 1333
	ErrSpCantAlter                                                  = 1334
	...
	ErrTooLongBody                                                  = 1437
	ErrWarnCantDroFIDelefaultKeycache                               = 1438
	ErrTooBigDisplaywidth                                           = 1439
	ErrXaerDupid                                                    = 1440
	ErrDatetimeFunctionOverflow                                     = 1441
	ErrCantUFIDelateUsedTableInSfOrTrg                              = 1442
	ErrViewPreventUFIDelate                                         = 1443
	...
	ErrDefCausCountDoesntMatchPleaseUFIDelate                       = 1558
	...
	ErrNativeFctNameDefCauslision                                   = 1585
	...
	ErrLoadDataInvalidDeferredCauset                                = 1611
	...
	ErrFuncInexistentNameDefCauslision                              = 1630
	...
	ErrPartitionDeferredCausetList                                  = 1653
	ErrWrongTypeDeferredCausetValue                                 = 1654
	...
	ErrSpatialMustHaveGeomDefCaus                                   = 1687
	...
	ErrInsideTransactionPreventsSwitchALLEGROSQLLogBin              = 1694
	ErrStoredFunctionPreventsSwitchALLEGROSQLLogBin                 = 1695
	...
	ErrMultiUFIDelateKeyConflict                                    = 1706
	ErrTableNeedsRebuild                                            = 1707
	WarnOptionBelowLimit                                            = 1708
	ErrIndexDeferredCausetTooLong                                   = 1709
	...
	ErrCantUFIDelateTableInCreateTableSelect                        = 1746
	...
	ErrMtsUFIDelatedDBsGreaterMax                                   = 1754
	...
	ErrVariableNotSetblockInSfOrTrigger                             = 1765
	ErrVariableNotSetblockInTransaction                             = 1766
	...
	ErrInnodbFtWrongDocidDeferredCauset                             = 1797
	...
	ErrDefCausCountDoesntMatchCorruptedV2                           = 1805
	...
	ErrInvalidYearDeferredCausetLength                              = 1818
	...
	ErrFkDeferredCausetCannotDrop                                   = 1828
	ErrFkDeferredCausetCannotDropChild                              = 1829
	ErrFkDeferredCausetNotNull                                      = 1830
	ErrDupIndex                                                     = 1831
	ErrFkDeferredCausetCannotChange                                 = 1832
	ErrFkDeferredCausetCannotChangeChild                            = 1833
	...
	ErrAlterOperationNotSupportedReasonDeferredCausetType           = 1850
	...
	ErrGeneratedDeferredCausetFunctionIsNotAllowed                  = 3102
	ErrUnsupportedAlterInplaceOnVirtualDeferredCauset               = 3103
	ErrWrongFKOptionForGeneratedDeferredCauset                      = 3104
	ErrBadGeneratedDeferredCauset                                   = 3105
	ErrUnsupportedOnGeneratedDeferredCauset                         = 3106
	ErrGeneratedDeferredCausetNonPrior                              = 3107
	ErrDependentByGeneratedDeferredCauset                           = 3108
	ErrGeneratedDeferredCausetRefAutoInc                            = 3109
	...
	ErrPHoTTexCantBeInvisible                                       = 3522
	...
	ErrCannotDropDeferredCausetFunctionalIndex                      = 3755
	...
	ErrWrongKeyDeferredCausetFunctionalIndex                        = 3761
	ErrFunctionalIndexOnField                                       = 3762
	ErrFKIncompatibleDeferredCausets                                = 3780
	...
	ErrForUFIDelateCantRetry               = 8002
	ErrAdminCheckTable                     = 8003
	ErrTxnTooLarge                         = 8004
	ErrWriteConflictInMilevaDB             = 8005
	...
	ErrSchemaReplicantExpired              = 8027
	ErrSchemaReplicantChanged              = 8028
	ErrBadNumber                           = 8029
	...
	ErrDeferredCausetStateNonPublic        = 8043
	ErrIndexStateCantNone                  = 8044
	ErrInvalidRecordKey                    = 8045
	ErrDeferredCausetStateCantNone         = 8046
	...
	ErrInvalidType                         = 8057
	ErrUnknownSlabPredictorType            = 8058
	...
	ErrDBSJobNotFound                         = 8224
	ErrCancelFinishedDBSJob                   = 8225
	ErrCannotCancelDBSJob                     = 8226
	ErrSequenceUnsupportedTableOption         = 8227
	ErrDeferredCausetTypeUnsupportedNextValue = 8228
	ErrLockExpire                             = 8229
	ErrAddDeferredCausetWithSequenceAsDefault = 8230
	...
	ErrFIDelServerTimeout              = 9001
	ErrEinsteinDBServerTimeout         = 9002
	ErrEinsteinDBServerBusy            = 9003
	ErrResolveLockTimeout              = 9004
	ErrRegionUnavailable               = 9005
	ErrGCTooEarly                      = 9006
	ErrWriteConflict                   = 9007
	ErrEinsteinDBStoreLimit            = 9008
	ErrPrometheusAddrIsNotSet          = 9009
	ErrEinsteinDBStaleCommand          = 9010
	ErrEinsteinDBMaxTimestampNotSynced = 9011
)
