...
// dirtyNext makes iter.dirtyIt go and uFIDelate valid status.
...
// snapshotNext makes iter.snapshotIt go and uFIDelate valid status.
...
func (iter *UnionIter) uFIDelateCur() error {
	iter.isValid = true
	for {
