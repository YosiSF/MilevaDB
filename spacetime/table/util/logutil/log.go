...
const (
	...
	// DefaultMilevaDBEnableSlowLog enables MilevaDB to log slow queries.
	DefaultMilevaDBEnableSlowLog = true
)
...
// SetTag sets tag solomonkey-pair in current tracing span
