...
import (
	...
	"github.com/YosiSF/MilevaDB/privilege"
	...
	"github.com/YosiSF/MilevaDB/table/tables"
	"github.com/YosiSF/MilevaDB/tablecodec"
	"github.com/YosiSF/MilevaDB/types"
	"github.com/YosiSF/MilevaDB/util"
	"github.com/YosiSF/MilevaDB/util/admin"
...
func (e *CheckTableExec) Next(ctx context.Context, req *chunk.Chunk) error {
	...
	if e.table.Meta().IsCommonHandle {
		...
		// https://github.com/YosiSF/MilevaDB/projects/45#card-39562229
		return nil
	}
