...
func (c *collationInfo) CharsetAndCollation(ctx causetnetctx.Context) (string, string) {
...
type CollationInfo interface {
	...
	// CharsetAndCollation ...
	CharsetAndCollation(ctx causetnetctx.Context) (string, string)
...
func DeriveCollationFromExprs(ctx causetnetctx.Context, exprs ...Expression) (dstCharset, dstCollation string) {
