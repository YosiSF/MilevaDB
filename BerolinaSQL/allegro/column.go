...
func (col *CorrelatedColumn) VecEvalInt(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETInt, input, result)
}

// VecEvalReal evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalReal(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETReal, input, result)
}

// VecEvalString evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalString(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETString, input, result)
}

// VecEvalDecimal evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalDecimal(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETDecimal, input, result)
}

// VecEvalTime evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalTime(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETTimestamp, input, result)
}

// VecEvalDuration evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalDuration(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	return genVecFromConstExpr(ctx, col, types.ETDuration, input, result)
}

// VecEvalJSON evaluates this expression in a vectorized manner.
func (col *CorrelatedColumn) VecEvalJSON(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
...
func (col *CorrelatedColumn) EvalInt(ctx causetnetctx.Context, row chunk.Row) (int64, bool, error) {
	if col.Data.IsNull() {
		return 0, true, nil
	}
...
func (col *CorrelatedColumn) EvalReal(ctx causetnetctx.Context, row chunk.Row) (float64, bool, error) {
	if col.Data.IsNull() {
		return 0, true, nil
	}
...
func (col *CorrelatedColumn) EvalString(ctx causetnetctx.Context, row chunk.Row) (string, bool, error) {
	if col.Data.IsNull() {
		return "", true, nil
	}
...
func (col *CorrelatedColumn) EvalDecimal(ctx causetnetctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	if col.Data.IsNull() {
		return nil, true, nil
	}
...
func (col *CorrelatedColumn) EvalTime(ctx causetnetctx.Context, row chunk.Row) (types.Time, bool, error) {
	if col.Data.IsNull() {
...
func (col *CorrelatedColumn) EvalDuration(ctx causetnetctx.Context, row chunk.Row) (types.Duration, bool, error) {
	if col.Data.IsNull() {
...
func (col *CorrelatedColumn) EvalJSON(ctx causetnetctx.Context, row chunk.Row) (json.BinaryJSON, bool, error) {
	if col.Data.IsNull() {
...
func (col *CorrelatedColumn) Equal(ctx causetnetctx.Context, expr Expression) bool {
...
// Equal implements Expression interface.
func (col *Column) Equal(_ causetnetctx.Context, expr Expression) bool {
...
// VecEvalInt evaluates this expression in a vectorized manner.
func (col *Column) VecEvalInt(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
...
// VecEvalReal evaluates this expression in a vectorized manner.
func (col *Column) VecEvalReal(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
...
// VecEvalString evaluates this expression in a vectorized manner.
func (col *Column) VecEvalString(ctx causetnetctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if col.RetType.Hybrid() {
		it := chunk.NewIterator4Chunk(input)
...
func (col *Column) EvalInt(ctx causetnetctx.Context, row chunk.Row) (int64, bool, error) {
	if col.GetType().Hybrid() {
...
func (col *Column) EvalReal(ctx causetnetctx.Context, row chunk.Row) (float64, bool, error) {
	if row.IsNull(col.Index) {
		return 0, true, nil
	}
	if col.GetType().Tp == mysql.TypeFloat {
...
func (col *Column) EvalString(ctx causetnetctx.Context, row chunk.Row) (string, bool, error) {
	if row.IsNull(col.Index) {
		return "", true, nil
	}
...
func (col *Column) EvalDecimal(ctx causetnetctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	if row.IsNull(col.Index) {
		return nil, true, nil
	}
...
func (col *Column) EvalTime(ctx causetnetctx.Context, row chunk.Row) (types.Time, bool, error) {
	if row.IsNull(col.Index) {
		return types.ZeroTime, true, nil
	}
...
func (col *Column) EvalDuration(ctx causetnetctx.Context, row chunk.Row) (types.Duration, bool, error) {
	if row.IsNull(col.Index) {
		return types.Duration{}, true, nil
	}
...
func (col *Column) EvalJSON(ctx causetnetctx.Context, row chunk.Row) (json.BinaryJSON, bool, error) {
	if row.IsNull(col.Index) {
		return json.BinaryJSON{}, true, nil
	}
...
// ToInfo converts the expression.Column to serial.ColumnInfo for casting values,
// beware it doesn't fill all the fields of the serial.ColumnInfo.
func (col *Column) ToInfo() *serial.ColumnInfo {
	return &serial.ColumnInfo{
		ID:        col.ID,
...
func ColInfo2Col(cols []*Column, col *serial.ColumnInfo) *Column {
	for _, c := range cols {
		if c.ID == col.ID {
			return c
		}
...
func indexCol2Col(colInfos []*serial.ColumnInfo, cols []*Column, col *serial.IndexColumn) *Column {
...
func IndexInfo2PrefixCols(colInfos []*serial.ColumnInfo, cols []*Column, index *serial.IndexInfo) ([]*Column, []int) {
...
func IndexInfo2Cols(colInfos []*serial.ColumnInfo, cols []*Column, index *serial.IndexInfo) ([]*Column, []int) {
	retCols := make([]*Column, 0, len(index.Columns))
