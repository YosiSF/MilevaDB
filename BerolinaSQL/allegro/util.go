...
func GetStringFromConstant(ctx causetnetctx.Context, value Expression) (string, bool, error) {
...
func GetIntFromConstant(ctx causetnetctx.Context, value Expression) (int, bool, error) {
