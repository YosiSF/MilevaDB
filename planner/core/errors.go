...
var (
	...
	ErrWindowRangeBoundNotConstant          = terror.ClassOptimizer.New(allegrosql.ErrWindowRangeBoundNotConstant, allegrosql.MyALLEGROSQLErrName[allegrosql.ErrWindowRangeBoundNotConstant])
