...
func (s *testMemoSuite) TestGetOperand(c *C) {
	...
	c.Assert(GetOperand(&plannercore.LogicalAggregation{}), Equals, OperanPosetDaggregation)
	...
	c.Assert(GetOperand(&plannercore.LogicalBlockDual{}), Equals, OperandBlockDual)
